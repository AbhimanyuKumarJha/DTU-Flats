...
const TransactionForm = ({ userId, onSubmit }) => {
  ...
  const addNewTransaction = () => {
    const lastTransaction = transactions[0]; // Since new transactions are added at the top
    let nextFromMonth = "";
    let nextFromYear = "";
    ...
    setTransactions((prev) => [
      {
        fromMonth: nextFromMonth, // Blank if first transaction
        fromYear: nextFromYear, // Blank if first transaction
